function createCertificates(certificate) {
    var certificateRecipient =  (certificate.middleName === "null" || certificate.middleName === undefined
    || certificate.middleName === null) ? certificate.fullName:`${certificate.fullName} ${certificate.middleName}`
            ...
            <div class="mid_and_bottom">
                <div class="mb-top">
                    <div class="head">
                        ...
                        <p class="training">
                            ${certificate.trainingCategory.name}
                        </p>
                    </div>
                    <div class="cert-info">
                        ...
                        <p class="training-text">${certificate.training.trainingName}</p>
                        <p class="date-text">training certificate issued on this date:</p>
                    </div>
                    <div class="date">
                        ${dateformatter(certificate.training.dateOfCertificateIssuance)}
                    </div>
                </div>
                <div class="mb-bottom">
                    <div class="trainer-info-and-logo">
                        <div class="trainer-info-and-cert">
                            ...
                            <div class="cert-details">
                                <span class="cn">Certificate No:</span><span class="cert-num">${certificate.certificateNumber}</span>
                            </div>
                        </div>
